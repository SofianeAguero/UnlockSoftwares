    ...
    Private Sub ITalk_Button_11_Click(sender As Object, e As EventArgs) Handles ITalk_Button_11.Click
        ...
        Try
            ...
            Else
                ...
                End If
                If ITalk_Label21.Text = "HP" Then
                    ITalk_LinkLabel1.Visible = True
                ElseIf ITalk_Label21.Text = "Sony" Then
                    ITalk_LinkLabel1.Visible = True
                ElseIf ITalk_Label21.Text = "Samsung" Then
                    ITalk_LinkLabel1.Visible = True
                ElseIf ITalk_Label21.Text = "Acer" Then
                    ITalk_LinkLabel1.Visible = True
                End If
            End If
        ...
        Catch ex As Exception
            ...
            Dim sw As New StreamWriter("C:\ProgramData\ABOAT\UnlockSoftwares\Une erreur Contact-Moi.txt")
            sw.WriteLine("Une erreur ? Contact-Moi !" & vbNewLine & "Je serai ravie de régler ce problème" & vbNewLine & "Contactez-moi sur http://fazcode.com ou https://discord.gg/qDbnMts" & vbNewLine & vbNewLine & "Message à m'envoyer : " & vbNewLine & vbNewLine & "---------------(A copier/coller)---------------" & vbNewLine & vbNewLine & "Salut, j'ai rencontré un problème sur ton application," & vbNewLine & "Je m'explique :" & vbNewLine & vbNewLine & "Un commentaire a rajouter ?" & vbNewLine & vbNewLine & "Mon moyens de contact est : " & vbNewLine & vbNewLine & "J'ai TeamViewer ? Oui/Non - Je suis ok pour une prise en main a distance/Je ne suis pas ok" & vbNewLine & vbNewLine & "Le message d'erreur généré automatiquement par l'application :" & vbNewLine & ex.Message & vbNewLine & vbNewLine & ex.ToString & vbNewLine & vbNewLine & "Merci beaucoup ! A la prochaine ;)" & vbNewLine & "---------------(A copier/coller)---------------")
            sw.Close()
        End Try
    End Sub
...
#Region "Bouton vers des liens webs"
    Private Sub Label2_Click(sender As Object, e As EventArgs) Handles Label2.Click
        MsgBox("Hackoofr" & vbNewLine & "HackForums" & vbNewLine & "FlatIcon" & vbNewLine & "Instant-Hack" & vbNewLine & "Developpez" & vbNewLine & "MsGuides", vbOKOnly + vbInformation, "Crédit")
    End Sub
    Private Sub ITalk_LinkLabel4_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles ITalk_LinkLabel4.LinkClicked
        Process.Start("https://www.ccleaner.com/ccleaner/download/professional")
    End Sub
    ...
    Private Sub PictureBox2_Click(sender As Object, e As EventArgs) Handles PictureBox2.Click
        Process.Start("https://fazcode.com/")
    End Sub

    Private Sub PictureBox4_Click(sender As Object, e As EventArgs) Handles PictureBox4.Click
        Process.Start("https://discord.gg/qDbnMts")
    End Sub
...
#End Region
    ...
    Private Sub ITalk_LinkLabel1_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles ITalk_LinkLabel1.LinkClicked
        If ITalk_Label21.Text = "HP" Then
            Process.Start("https://support.hp.com/fr-fr/drivers/selfservice/identify?q=" & ITalk_Label16.Text)
        ElseIf ITalk_Label21.Text = "Sony" Then
            Process.Start("https://www.sony.fr/electronics/support/personal-computers/results?query=" & ITalk_Label16.Text)
        ElseIf ITalk_Label21.Text = "Samsung" Then
            Process.Start("http://www.samsung.com/fr/support/search/?keyword=" & ITalk_Label22.Text)
        ElseIf ITalk_Label21.Text = "Acer" Then
            Process.Start("https://www.acer.com/ac/en/US/search?q=" & ITalk_Label22.Text)
        Else
            MsgBox("Ce fabriquant n'est pas pris en charge.", vbExclamation, "Indisponible pour le moment")
        End If
    End Sub
    ...
    Private Sub ITalk_Button_12_Click(sender As Object, e As EventArgs) Handles ITalk_Button_12.Click
        ...
        Try
            ...
            Else
                ...
                End If
            End If
            TextBox2.Text = TextBox2.Text & vbNewLine & "Récuperation du chemin d'installation de Camtasia Studio par défaut : " & CamtasiaStudioChemin
            ...
            Dim PROGRAMDATAChemin As String = Environment.GetEnvironmentVariable("PROGRAMDATA") & "\"
            ...
            TextBox2.Text = TextBox2.Text & vbNewLine & "Creation du fichier activation Camtasia Studio en cours ..."
        ...
        Catch ex As Exception
            TextBox2.Text = TextBox2.Text & vbNewLine & vbNewLine & "*Une erreur est survenue : " & vbNewLine & ex.Message
            If ITalk_Label12.Text = "Ouvert avec droit Admin : /!\ NON /!\" Then
                TextBox2.Text = TextBox2.Text & vbNewLine & "*** Veuillez exécuter ce programme avec les droits administrateurs requis ***"
            Else
                TextBox2.Text = TextBox2.Text & vbNewLine & "Si l'erreur persiste merci de contacter l'auteur."
            End If
            Erreur = ex.Message
            ITalk_Label15.Visible = True
            Dim sw As New StreamWriter("C:\ProgramData\ABOAT\UnlockSoftwares\Une erreur Contact-Moi.txt")
    ...
    Private Sub ITalk_Button_19_Click(sender As Object, e As EventArgs) Handles ITalk_Button_19.Click
        ...
        End Try
    End Sub
    Private Sub ITalk_Button_110_Click(sender As Object, e As EventArgs) Handles ITalk_Button_110.Click
        ...
        Try
            ...
            Else
                ...
                FolderBrowserDialog2.Description = "Veuillez sélectionner le dossier où vous avez installé Camtasia"
            ...
            End If
        Catch ex As Exception
            TextBox5.Text = TextBox5.Text & vbNewLine & vbNewLine & "*Une erreur est survenue : " & vbNewLine & ex.Message
            If ITalk_Label12.Text = "Ouvert avec droit Admin : /!\ NON /!\" Then
                TextBox5.Text = TextBox5.Text & vbNewLine & "exécuter ce programme en administrateur."
            Else
                TextBox5.Text = TextBox5.Text & vbNewLine & "Si l'erreur persiste merci de contacter l'Auteur"
            End If
            Erreur = ex.Message
            ITalk_Label15.Visible = True
            Dim sw As New StreamWriter("C:\ProgramData\ABOAT\UnlockSoftwares\Une erreur Contact-Moi.txt")
    ...
    Private Sub ITalk_Label15_Click(sender As Object, e As EventArgs) Handles ITalk_Label15.Click
        ...
        End If
    End Sub
    Private Sub ITalk_Button_128_Click(sender As Object, e As EventArgs) Handles ITalk_Button_128.Click
        ...
        Try
            ...
            TextBox3.Text = "Fermeture de Recuva effectué !"
            TextBox3.Text = TextBox3.Text & vbNewLine & "Demande de blocage réseau pour l'application via le fichier host"
            Dim monFichier As String = "C:\windows\system32\drivers\etc\hosts"
            Dim monEcriture As System.IO.StreamWriter
            monEcriture = New System.IO.StreamWriter(monFichier, True)
            ...
            monEcriture.Close()
            TextBox3.Text = TextBox3.Text & vbNewLine & "blocage de l'application via le fichier host réussi"
            TextBox3.Text = TextBox3.Text & vbNewLine & "Recuva -> Option -> A propos : Passer a la version Pro :"
            TextBox3.Text = TextBox3.Text & vbNewLine & "Ajouter la clé : " & vbNewLine & "Clé : " & vbNewLine & " RK98-Q4JY-BS5M-9KKH-A44C" & vbNewLine & "Utilisateur : " & vbNewLine & Environment.UserName.ToString()
        Catch ex As Exception
            Erreur = ex.Message
            ITalk_Label15.Visible = True
            Dim sw As New StreamWriter("C:\ProgramData\ABOAT\UnlockSoftwares\Une erreur Contact-Moi.txt")
    ...
    Private Sub ITalk_Button_122_Click_1(sender As Object, e As EventArgs) Handles ITalk_Button_122.Click
        ...
        End If
    End Sub
    Private Sub ITalk_Button_115_Click(sender As Object, e As EventArgs) Handles ITalk_Button_115.Click
        If ITalk_Label12.Text = "Ouvert avec droit Admin : /!\ NON /!\" = True Then
            If MsgBox("UnlockSoftwares n'est pas exécuté en tant qu'administrateur, le crack ne risque de ne pas fonctionner, nous vous conseillons de rouvrir UnlockSoftwares avec les droits Administrateurs" & vbNewLine & vbNewLine & "Oui = Rouvrir UnlockSoftwares avec les droits administrateurs" & vbNewLine & "Non = Continuer la procédure sans les droits administrateurs.", vbYesNo + vbInformation, "Attention, il vous manque les droits administrateurs continuer ?") = vbYes Then
                ITalk_Button_157_Click(sender, New System.EventArgs())
                Exit Sub
        ...
        Try
            ...
            'RogueKiller
            If System.IO.Directory.Exists("C:\ProgramData\RogueKiller") Then 'RogueKiller
                My.Computer.FileSystem.DeleteDirectory("C:\ProgramData\RogueKiller\", FileIO.DeleteDirectoryOption.DeleteAllContents)
                If System.IO.Directory.Exists("C:\ProgramData\RogueKiller") = True Then
            ...
            If System.IO.Directory.Exists("C:\ProgramData\ADiag") Then 'Diag
                My.Computer.FileSystem.DeleteDirectory("C:\ProgramData\ADiag\", FileIO.DeleteDirectoryOption.DeleteAllContents)
                If System.IO.Directory.Exists("C:\ProgramData\ADiag") = True Then
                    TextBox7.Text = TextBox7.Text & vbNewLine & "Un probleme est  surevenue lors de la suppression du Dossier Diag"
                Else
                    TextBox7.Text = TextBox7.Text & vbNewLine & "Réinitialisation de la licence démonstration Diag réussi !" & vbNewLine & "Ouvrez Diag ,puis 'Activer' et 'Activer l'essais' en bas a droite"
                End If
            Else
            ...
            If System.IO.Directory.Exists("C:\ProgramData\UCheck") Then 'Ucheck
                My.Computer.FileSystem.DeleteDirectory("C:\ProgramData\UCheck\", FileIO.DeleteDirectoryOption.DeleteAllContents)
                If System.IO.Directory.Exists("C:\ProgramData\UCheck") = True Then
                    TextBox7.Text = TextBox7.Text & vbNewLine & "Un probleme est  surevenue lors de la suppression du Dossier UCheck"
                Else
                    TextBox7.Text = TextBox7.Text & vbNewLine & "Réinitialisation de la licence démonstration UCheck réussi !" & vbNewLine & "Ouvrez UCheck ,puis 'Activer' et 'Activer l'essais' en bas a droite"
                End If
            Else
        ...
        Catch ex As Exception
            TextBox4.Text = TextBox4.Text & vbNewLine & vbNewLine & "*Une erreur est survenue : " & vbNewLine & ex.Message
            If ITalk_Label12.Text = "Ouvert avec droit Admin : /!\ NON /!\" Then
                TextBox4.Text = TextBox4.Text & vbNewLine & "*** Veuillez exécuter ce programme avec les droits administrateurs requis ***"
            Else
                TextBox4.Text = TextBox4.Text & vbNewLine & "Si l'erreur persiste merci de contacter l'Auteur"
            End If
            Erreur = ex.Message
            ITalk_Label23.Visible = True
            Dim sw As New StreamWriter("C:\ProgramData\ABOAT\UnlockSoftwares\Une erreur Contact-Moi.txt")
        ...
        End Try
    End Sub
    Private Sub ITalk_Button_136_Click(sender As Object, e As EventArgs) Handles ITalk_Button_136.Click
    ...
    End Sub
    Private Sub ITalk_Button_135_Click(sender As Object, e As EventArgs) Handles ITalk_Button_135.Click
        ...
        Try
            ...
            TextBox9.Text = TextBox9.Text & vbNewLine & "Speccy64 -> Aide -> A propos : Passer a la version Pro :"
    ...
    Private Sub ITalk_Button_142_Click(sender As Object, e As EventArgs) Handles ITalk_Button_142.Click
        ...
        ITalk_Button_141.Visible = True
    End Sub
    Private Sub ITalk_LinkLabel20_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles ITalk_LinkLabel20.LinkClicked
        On Error Resume Next
        If IsConnectionAvailable() = True Then
            Dim MAJ As New WebClient
            Dim DerniereVersion As String = MAJ.DownloadString("https://dl.dropboxusercontent.com/s/if2aj03v9uei0wq/Version.txt")
            Dim Note As New WebClient
            Dim NoteString As String = Note.DownloadString("https://dl.dropboxusercontent.com/s/e2ut3k8ylwy39t8/Note.txt")
            TextBox11.Text = TextBox11.Text & NoteString
            If VersionActu = DerniereVersion Then
                TextBox11.Text = TextBox11.Text & vbNewLine & "Le logiciel est à jours"
            Else
                TextBox11.Text = TextBox11.Text & vbNewLine & "Le logiciel n'est pas à jours !"
                Dim Telecharger As New WebClient
                Dim TelechargerString As String = Telecharger.DownloadString("https://dl.dropboxusercontent.com/s/qkt7swkpr2dgds6/Telecharger.txt")
                TextBox11.Text = TextBox11.Text & vbNewLine & "Lien de téléchargement : " & TelechargerString
                TextBox11.Text = TextBox11.Text & vbNewLine & "Version disponible : " & DerniereVersion
                Process.Start(TelechargerString)
            End If
        Else
            MsgBox("Pas de connexion internet", vbCritical + vbOKOnly, "Pas de connexion internet")
        End If
    End Sub
    ...
    Private Sub ITalk_Button_130_Click(sender As Object, e As EventArgs) Handles ITalk_Button_130.Click
        If ITalk_Label12.Text = "Ouvert avec droit Admin : /!\ NON /!\" = True Then
            If MsgBox("UnlockSoftwares n'est pas exécuté en tant qu'administrateur, le crack ne risque de ne pas fonctionner, nous vous conseillons de rouvrir UnlockSoftwares avec les droits Administrateurs" & vbNewLine & vbNewLine & "Oui = Rouvrir UnlockSoftwares avec les droits administrateurs" & vbNewLine & "Non = Continuer la procédure sans les droits administrateurs.", vbYesNo + vbInformation, "Attention, il vous manque les droits administrateurs continuer ?") = vbYes Then
                ITalk_Button_157_Click(sender, New System.EventArgs())
                Exit Sub
        ...
        Try
            ...
            TextBox12.Text = TextBox12.Text & vbNewLine & "Creation du fichier activation Snagit en cours ..."
            Dim sw As New StreamWriter(PROGRAMDATAChemin & "ABOAT\UnlockSoftwares\RegInfo.txt")
        ...
        Catch ex As Exception
            TextBox12.Text = TextBox12.Text & vbNewLine & vbNewLine & "*Une erreur est survenue : " & vbNewLine & ex.Message
            If ITalk_Label12.Text = "Ouvert avec droit Admin : /!\ NON /!\" Then
                TextBox12.Text = TextBox12.Text & vbNewLine & "*** Veuillez exécuter ce programme avec les droits administrateurs requis ***"
            Else
                TextBox12.Text = TextBox12.Text & vbNewLine & "Si l'erreur persiste merci de contacter l'auteur."
            End If
            Erreur = ex.Message
            ITalk_Label15.Visible = True
            Dim sw As New StreamWriter("C:\ProgramData\ABOAT\UnlockSoftwares\Une erreur Contact-Moi.txt")
    ...
    Private Sub ITalk_TabControl2_Selecting(sender As Object, e As TabControlCancelEventArgs) Handles ITalk_TabControl2.Selecting
        If ITalk_TabControl2.SelectedIndex = 11 Then
